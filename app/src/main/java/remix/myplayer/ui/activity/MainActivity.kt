...
open class MainActivity : MenuActivity(), View.OnClickListener {
  ...
  private fun setUpSwitch(){
    night_mode_switch.isChecked = !isLightTheme()
    night_mode_switch.setOnClickListener {
  ...
  private fun setUpTab() {
    ...
    tabs.setSelectedTabIndicatorColor(if (isPrimaryColorCloseToWhite) getAccentColor() else Color.WHITE)
  ...
  private fun setUpViewColor() {
    ...
    btn_add.background = Theme.tintDrawable(R.drawable.bg_playlist_add, getAccentColor())
    btn_add.setImageResource(R.drawable.icon_playlist_add)

    header_txt.setTextColor(getTextColorPrimary())
    night_mode_text.setTextColor(getTextColorPrimary())
  }
  ...
  override fun onMetaChanged() {
    ...
    if (currentSong != Song.EMPTY_SONG) {
      header_txt.text = currentSong.title
      header_artist.text = currentSong.artist
      LibraryUriRequest(header_img,
