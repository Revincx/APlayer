...
//    }
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    layout_player.setBackgroundColor(ThemeStore.getPlayerBgColor())
//    layout_player.setBackgroundColor(Color.TRANSPARENT)
...
//      mRecordFragment = new RecordFragment();
      ...
      //下滑关闭
      view_pager.setOnTouchListener { _: View?, event: MotionEvent ->
...
//        Theme.tintDrawable(mVolumeUp,R.drawable.ic_volume_up_black_24dp,tintColor);
  ...
  private fun updateBgCover(song: Song){
    Timber.d("尝试请求封面Uri")
    object : ImageUriRequest<String?>() {
      override fun onError(throwable: Throwable) {
        bg_cover.setActualImageResource(R.drawable.album_empty_bg_day)
      }

      override fun onSuccess(result: String?) {
        Timber.d("ImageUri: $result")
        ImageUriUtil.showUrlBlur(bg_cover, Uri.parse(result),1,8)
      }
