...
import static remix.myplayer.bean.misc.Category.TAG_PLAYLIST;
...
public class MainPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        Fragment fragment = category.getTag() == TAG_PLAYLIST ? new PlayListFragment() :
                category.getTag() == Category.TAG_SONG ? new SongFragment() :
