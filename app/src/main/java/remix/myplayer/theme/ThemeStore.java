...
//    }
  ...
  public static int getMaterialPrimaryColor() {
    ...
    int primaryColor = SPUtil
        .getValue(App.getContext(), NAME, KEY_PRIMARY_COLOR, Color.parseColor("#ffffff"));
//    if (ColorUtil.isColorCloseToWhite(primaryColor)) {
//      primaryColor = ColorUtil.getColor(R.color.accent_gray_color);
//    }
    return isLightTheme()? primaryColor :ColorUtil.getColor(R.color.dark_background_color_main);
...
//    }
  ...
  public static int getStatusBarColor() {
    if (isLightTheme())
      ...
      return ColorUtil.getColor(R.color.dark_background_color_main);
  }
  ...
  @ColorInt
  public static int getPlayerStatusBarColor()
  {
